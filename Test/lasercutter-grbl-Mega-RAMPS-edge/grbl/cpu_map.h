...
//  #define LIMIT_MASK ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<Z_LIMIT_BIT)) // All limit bits
  ...
  #define SPINDLE_ENABLE_BIT      5 // MEGA2560 Digital Pin 4
  ...
  #define SPINDLE_PWM_MAX_VALUE     772.0 // Translates to about 1.9 kHz PWM frequency at 1/8 prescaler
  #ifndef SPINDLE_PWM_MIN_VALUE
    #define SPINDLE_PWM_MIN_VALUE   54   // Must be greater than zero. Remap for CO2 laser: it starts from 7% of max power
  #endif
  ...
  #define SPINDLE_TCCRA_INIT_MASK ((0<<WGM40) | (1<<WGM41))
  ...
  #define SPINDLE_OCRA_TOP_VALUE  0x0304 // PWM counter reset value. Should be the same as PWM_MAX_VALUE in hex.
